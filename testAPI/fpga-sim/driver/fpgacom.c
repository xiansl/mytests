...
void create_acc_list (void) {
	...
	filp=filp_open ("/home/900/lxs900/zzd/testAPI/fpga-sim/driver/wukong.conf", O_RDONLY, 0);
	if (IS_ERR (filp)) {
		printk ("Warning: /home/900/lxs900/zzd/testAPI/fpga-sim/driver/wukong.conf is not found. No ACC will be enable.\n");
		return;
	}
